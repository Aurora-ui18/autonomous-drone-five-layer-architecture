...
框架不是一次性设计，而是在多届全国级竞赛中**实飞迭代**沉淀而来：

| 阶段 | 场景 | 框架形态 | 关键演进 |
|------|------|---------|---------|
| 第 28 届 CRAIC 国赛 | 无人机竞赛任务 | 脚本式雏形（`demo.py` + 功能库） | 首次完整实飞，暴露"脚本堆叠难维护"问题 |
| 2025 H 题 · 野生动物巡查 | 巡查任务 | 脚本式延续 | 新增地面站通信与网格全覆盖路径规划 |
| 2024 D 题 · 立体货架盘点 | 货架盘点 | ⭐ **第一次整体重构：五层解耦成型** | 代码按五层拆分目录，公共层 / 安全旁路 / 记录层建立 |
| 2023 G 题 · 空地协同智能消防 | 空地协同 | 五层框架演进 | 车机协同通信、火源检测、6×5 全覆盖巡逻 |
| 2026 D 题 · 搜救飞行器（本科） | 搜救任务 | **五层框架完善版** | 10Hz 流式 MAVLink、Timer 状态机、QR 出口解码、A* 引导、三色投放、视觉伺服降落 |
